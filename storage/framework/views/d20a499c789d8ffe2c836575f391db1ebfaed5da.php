...
<head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('css/creative.css')); ?>" type="text/css">
...
<body id="page-top">
    ...
    <script src="<?php echo e(asset('js/jquery.fittext.js')); ?>"></script>
    <script src="<?php echo e(asset('js/wow.min.js')); ?>"></script>

    <!-- Custom Theme JavaScript -->
    <script src="<?php echo e(asset('js/creative.js')); ?>"></script>
